...
use crate::core::theme::{theme, transparent_color, AUTO, YG_UNDEFINED};
use crate::core::view_box::BoxView;
use nanovg::Context;
use nanovg_sys::{
    nvgBeginFrame, nvgBeginPath, nvgBoxGradient, nvgEndFrame, nvgFill, nvgFillColor, nvgFillPaint,
...
use yoga_sys::{
    YGDirection, YGEdge, YGNodeCalculateLayout, YGNodeFree, YGNodeLayoutGetHeight,
    YGNodeLayoutGetLeft, YGNodeLayoutGetMargin, YGNodeLayoutGetPadding, YGNodeLayoutGetTop,
    YGNodeLayoutGetWidth, YGNodeNew, YGNodeRef, YGNodeStyleSetAlignSelf, YGNodeStyleSetFlexGrow,
...
impl Default for ViewData {
    fn default() -> Self {
        Self {
            ...
            background_color: theme::nvg_rgba(0, 0, 0, 0),
            background_start_color: transparent_color(),
            background_end_color: theme::nvg_rgba(0, 0, 0, 200),
            ...
            show_shadow: true,
            border_color: theme::nvg_rgb(255, 0, 0),
            border_thickness: 1.0,
            visibility: Visibility::Visible,
            line_color: theme::nvg_rgb(0, 255, 0),
            line_top: 0.1,
            line_left: 0.1,
            line_bottom: 0.1,
            line_right: 0.1,
